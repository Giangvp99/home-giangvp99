...
local titlebar_icon_path = os.getenv("HOME") .. "/.config/awesome/theme/icons/titlebar/" .. titlebar_theme .. "/"
local tip                = titlebar_icon_path

-- Layout Dir :
local layout_icon_path = os.getenv("HOME") .. "/.config/awesome/theme/icons/layouts/"
local lip              = layout_icon_path

-- others Icons :
local others_icon_path = os.getenv("HOME") .. "/.config/awesome/theme/icons/others/"
...
theme.iconfont     = "FiraCode Nerd Font 10"
...
theme.calendar_border_width   = dpi(0)
theme.calendar_bg_1           = colors.black
theme.calendar_bg_2           = colors.container
theme.calendar_shape          = function(cr, w, h)
    gears.shape.rounded_rect(cr, w, h, 4)
end
theme.calendar_normal_padding = dpi(6)
